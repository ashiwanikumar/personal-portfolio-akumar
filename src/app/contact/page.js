...
export const metadata = generatePageMetadata({
	...
	description: "Start a conversation about DevOps consulting, cloud infrastructure or SRE work. Based in Abu Dhabi, UAE, and open to contract and full-time roles.",
